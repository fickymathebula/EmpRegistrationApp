<%@ Page Title="Edit Employee" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="Employee_Edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <asp:Button runat="server" Text="Edit" CssClass="btn btn-default" ID="btnEdit" OnClick="btnEdit_Click" />
                </div>
            </div>
